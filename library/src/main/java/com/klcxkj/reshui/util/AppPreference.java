...
public class AppPreference {
    ...
    public void savePassWord(String passWord){
        if (mCfgPreference != null) {
            ...
            try {
                localEditor.putString("anjie_passWord", SimpleCrypto.encrypt(SEED, passWord));
            } catch (Exception e) {
                e.printStackTrace();
                localEditor.putString("anjie_passWord", passWord);
            }
            localEditor.commit();
        }
    }
    ...
    public String getPassWord(){
        if (mCfgPreference != null) {
            String passWord = mCfgPreference.getString("anjie_passWord", "");
    ...
    public void saveLoginUser(UserInfo userInfo) {
        if (mCfgPreference != null) {
            ...
            try {
                ...
                e.printStackTrace();
                localEditor.putString("userinfo_custom", gson.toJson(userInfo));
            }
            localEditor.commit();
        }
    }
        ...
        if (mCfgPreference != null) {
            ...
            if(!StringUtils.isEmpty(encyptPhone))
                try {
                    ...
                    e.printStackTrace();
                    return gson.fromJson(encyptPhone, UserInfo.class);
                }
        }
        return null;
    }
    ...
    public void saveCardInfo(String cardJson) {
        if (mCfgPreference != null) {
            ...
            try {
				...
				e.printStackTrace();
                localEditor.putString("CardInfo_custom", cardJson);
			}
            localEditor.commit();
        }
    }
    ...
    public void saveCardInfos(CardInfo cardJson) {
        if (mCfgPreference != null) {
            ...
            try {
                ...
                e.printStackTrace();
                localEditor.putString("CardInfo_custom", gson.toJson(cardJson));
            }
            localEditor.commit();
        }
    }
        ...
        if (mCfgPreference != null) {
        	...
        	if(!StringUtils.isEmpty(encyptPhone))
				try {
					...
					e.printStackTrace();
                    return gson.fromJson(encyptPhone, CardInfo.class);
				}
        }
        return null;
    }
